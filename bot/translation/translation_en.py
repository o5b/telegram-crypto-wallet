...
START_MESSAGES: dict[str, str] = {
    "/start": "<b>👋 Hello, {first_name}!</b>\n\n"
              ...
              "<i>🤖 The bot is currently using the Solana network:</i>\n"
              "<i>{node}</i>"
...
HELP_MESSAGES: dict[str, str] = {
    "/help": "<b>Description of the bot functionality:</b>\n\n"
             "🔑 <b>Create wallet:</b>\n\n<i>Allows you to create a new BSC wallet."
             ...
             "🔗<b> Connect wallet:</b>\n\n<i>Allows you to connect an existing BSC wallet to your account."
             ...
             "📲<b> Transfer token:</b>\n\n<i>Transfers BNB between your BSC wallets. Select a sender, enter the "
             ...
             "registered BSC wallets. After selecting the desired wallet from the list, the bot will display the "
...
TOKEN_TRANSFER_TRANSACTION_MESSAGE = {
    ...
    "list_sender_tokens": "<b>📋 Your token list:</b>\n\n<i>Click on the relevant token:</i>",
    ...
    "insufficient_balance_recipient_bsc": "<b>❌ The recipient's balance</b>",
...
TRANSLATION_EN: dict[str, str] = {**CREATE_WALLET_MESSAGE, **OTHER_BUTTONS, **CONNECT_WALLET_MESSAGE, **HELP_MESSAGES,
