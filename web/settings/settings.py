...
#     'web.applications.account',
#     'web.applications.wallet',
# ]
...
ROOT_URLCONF = 'web.settings.urls'
...
WSGI_APPLICATION = 'web.settings.wsgi.application'
ASGI_APPLICATION = 'web.settings.asgi.application'
